...
<div id="page-wrapper">
   <div class="container-fluid">
	...
	{!!Form::open(['method' => 'POST', 'action' => 'HeaderController@store','files' => true]) !!}	  
      <div class="row">
         <div class="col-lg-12">
            ...
            <div class="form-group" style="overflow: hidden;">
               {!! Form::select('ex_validity',array('validity' => 'Validity', 'iisla_no' => 'IIISLA No'),null,['class' => 'form-control col-md-2','id'=>'ex_validity','style'=>'width:15%;margin-right:20px']) !!}  
               <div class="col-md-6" id="expire">
                  {!! Form::text('expire',null,['class' => 'form-control col-md-6',]) !!}
