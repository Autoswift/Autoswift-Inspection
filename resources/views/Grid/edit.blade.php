...
<div id="page-wrapper">
   <div class="container-fluid">
      ...
      <section class="content container-fluid">
       ...
       {!! Form::model($grid, ['method' => 'PATCH', 'action' => ['GridController@update', $grid->id],'id'=>'gridform']) !!}      
      <div class="row">
               ...
               <div class="col-md-6">
                  <select class="form-control col-md-6" id="vehicle_make" name="vehicle_make">
                     ...
                     @foreach($vehicle_make as $item)
                        <option value="{{$item}}"{{$item==$grid->vehicle_make?'selected':''}}>{{$item}}</option>
                     @endforeach
         ...
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               ...
               <div class="col-md-6">
                  {!! Form::select('vehicle_model',array($grid->vehicle_model=>$grid->vehicle_model,'other'=>'Other'),$grid->vehicle_model, ['class' => 'form-control col-md-6','placeholder'=>'First Select Vehicle Make']) !!}
         ...
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               ...
               <div class="col-md-6">
                  {!! Form::select('variant',array($grid->variant=>$grid->variant,'other'=>'Other'),$grid->variant, ['class' => 'form-control col-md-6','placeholder'=>'First Select Vehicle Model']) !!}
         ...
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               ...
               <div class="col-md-6">
                  {!! Form::select('year',array($grid->year=>$grid->year,'other'=>'Other'),$grid->year, ['class' => 'form-control col-md-6','placeholder'=>'First Select Variant']) !!}
