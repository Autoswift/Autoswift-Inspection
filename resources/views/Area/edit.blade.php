...
@section('title', 'Edit City Or Area')
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <small>Edit City Or Area</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                               <i class="fa fa-dashboard"></i><a href="{{route('home')}}"> Dashboard</a>                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> Edit City Or Area  
                            </li>
      ...
      <div class="row">
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               ...
               <div class="col-md-6">
                  {!! Form::select('state_id',$all_state,null, ['class' => 'form-control col-md-6']) !!}
