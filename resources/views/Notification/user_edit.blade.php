...
<div id="page-wrapper">
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
               ...
               <li class="active">
                  <i class="fa fa-edit"></i> Edit Notification
               </li>
               <span style="float:right;"><a href="{{route('user_notification.index')}}"><i class="fa fa-arrow-left"></i> Back</a></span>
            </ol>
         </div>
      </div>
      ...
      {!! Form::model($userNotification, ['method' => 'PATCH', 'action' => ['UserNotificationController@update', $userNotification->id],'id'=>'notificatio_edit']) !!}    
      <div class="row">
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               {!! Form::label('Company Name', 'Company Name*',['class' => 'col-md-2',"placeholder"=>"Select Company"]) !!}
               <div class="col-md-6">
                  {!! Form::Select('valuations_by',$company,$userNotification->valuations_by,['class' => 'form-control col-md-6']) !!}
         ...
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               ...
               <div class="col-md-6">
                  {!! Form::Select('state',[$notification->state_id=>$notification->state_name],null, ['class' => 'form-control col-md-6']) !!}
         ...
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               ...
               <div class="col-md-6">
                  {!! Form::Select('area_id',[$userNotification->area_id=>$notification->area_name],null,['class' => 'form-control col-md-6']) !!}
         ...
         <div class="col-lg-12">                 
            <div class="form-group" style="overflow: hidden;">
               ...
               <div class="col-md-6">
                  {!! Form::Select('user_id',[$userNotification->user_id=>$notification->exe_name], null, ['class' => 'form-control col-md-6']) !!}
...
<script>
    ...
    $(function() {
        $('select').change(function() {
            ...
            formdata=$("#notificatio_edit select").serialize()
